...
if ($_SERVER ['REQUEST_METHOD'] == 'POST') {
	...
	if ($crud->retornoExiste ( $_POST ["codretirada"] )) {
		if ($crud->insertDesp ( $_POST ["codretirada"], $_POST ["quantidade"], $_POST ["motivo"] )) {
			$crud->alteraStatus ( $_POST ["codretirada"] );
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label">C&oacute;digo de
											retirada do produto</label>
										<div class="col-sm-9">
											<input required="true" value="<?php echo $cod_retirada; ?>"
												type="number" class="form-control"
												placeholder="C&oacute;digo de retirada" name="codretirada"
												id="codretirada" min="1">
										</div>
									</div>

									<div class="form-group">
										<label class="col-sm-3 control-label">Quantidade
											desperdi&ccedil;ada</label>
										<div class="col-sm-9">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea required="true" class="form-control" rows="3"
												placeholder="Descreva o motivo do desperd&iacute;cio"
												name="motivo" id="motivo"></textarea>
										</div>
									</div>
